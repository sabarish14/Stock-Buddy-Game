...
<font color="#CC66FF" face="Comic Sans MS, cursive" size="+1">Welcome,<label for="uname"><%=user.getUname()%></label>
</font>
<p>
<center>
<form action="videoe" method="get">
<fieldset>
<input type="file" name="fileupload"><br>
<input type="hidden" value="<%=user.getUname()%>" name="label" />
<br>Enter description<textarea rows="4" cols="50" name="descrip"></textarea>
