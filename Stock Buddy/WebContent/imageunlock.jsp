...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
 ...
 <jsp:useBean id="file" class="registerpkg.userdata" scope="session"  />
...
// Prepare a statement object used to execute query
 ...
 String sql = "SELECT filename,descrip from savefile1 where uname='"+user.getUname()+"'"; 
...
<td><input type="button" name="button2" onclick="location.href='viewfilepart.jsp?id=<%=rs.getString("filename")%>'; " value="Click Here"/></td>
</tr>
<%
 } 
%>
